...
const BooleanValueObjectTyper_1 = require("./BooleanValueObjectTyper");
...
class BooleanValueObject extends ValueObject_1.ValueObject {
    constructor(value) {
        super(new BooleanValueObjectOperator_1.BooleanValueObjectOperator(), new BooleanValueObjectTyper_1.BooleanValueObjectTyper(), new BooleanValueObjectValidator_1.BooleanValueObjectValidator(), value);
